...
import isInRepositoriesList from '../utils/isInRepositoriesList.js';
/**
 ...
 */
function scopeCheck(toolbox, command) {
    const { fileSystem: { read, isDirectory }, print: { error }, path, } = toolbox;
