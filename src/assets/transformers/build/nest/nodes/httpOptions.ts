...
const httpOptions = ts.factory.createVariableStatement(
  undefined,
              ...
              ts.factory.createCallExpression(
                ...
                [
                  ts.factory.createCallExpression(
                    ...
                    undefined,
                    [ts.factory.createIdentifier('__dirname'), ts.factory.createStringLiteral('../sslcert/xxx-key.pem')]
                  ),
                ]
              )
            ),
              ...
              ts.factory.createCallExpression(
                ...
                [
                  ts.factory.createCallExpression(
                    ts.factory.createPropertyAccessExpression(ts.factory.createIdentifier('path'), ts.factory.createIdentifier('join')),
                    undefined,
                    [ts.factory.createIdentifier('__dirname'), ts.factory.createStringLiteral('../sslcert/xxx-cert.pem')]
                  ),
                ]
              )
            ),
